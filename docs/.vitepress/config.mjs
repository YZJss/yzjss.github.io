      ...
      '/ml/': [
        {
          ...
          items: [
            ...
            { text: '第 5 章 逻辑回归', link: '/ml/logistic-regression' },
            { text: '第 6 章 模型评估', link: '/ml/advice-for-applying-ml' },
            { text: '第 7 章 正则化', link: '/ml/regularization' },
            { text: '第 8 章 特征工程和降维', link: '/ml/dimensionality-reduction' },
            { text: '第 9 章 聚类', link: '/ml/clustering' },
            { text: '第 10 章 异常检测', link: '/ml/anomaly-detection' },
            { text: '第 11 章 支持向量机', link: '/ml/svm' },
            { text: '第 12 章 推荐系统', link: '/ml/recommender-systems' },
            ...
            { text: '第 16 章 卷积神经网络', link: '/ml/cnn' },
            { text: '第 17 章 序列模型', link: '/ml/sequence-models' },
            { text: '第 18 章 Attention 和 Transformer', link: '/ml/photo-ocr' },
            { text: '第 19 章 图神经网络', link: '/ml/gnn' },
            { text: '第 20 章 概率图模型', link: '/ml/ml-system-design' },
            { text: '第 21 章 生成模型', link: '/ml/generative-models' },
            { text: '第 22 章 迁移学习', link: '/ml/transfer-learning-pretraining' },
            { text: '第 23 章 大模型基础', link: '/ml/transformer' },
            { text: '第 24 章 AI Agent', link: '/ml/ai-agent' },
            { text: '第 25 章 机器学习工程', link: '/ml/large-scale-ml' },
            { text: '第 26 章 综合复习', link: '/ml/conclusion' }
          ]
        }
      ],
      '/blog/': [
