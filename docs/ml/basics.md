...
Arthur Saμel 把机器学习理解为：在没有明确编程的情况下，让计算机具备学习能力。
...
| 无监督学习 | 无标签，没有提前给出正确答案 | 聚类、降维 |

按建模方式划分：

| 类型 | 关注点 | 常见理解 |
| --- | --- | --- |
| 生成式模型 | 数据是如何产生的 | 建模联合分布，例如每一类数据分别长什么样 |
| 判别式模型 | 类别之间如何区分 | 直接建模分类边界或条件概率 |
