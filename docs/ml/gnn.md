...
图神经网络（Graph Neural Network, GNN）用于处理图结构数据。图由节点和边组成，适合表示社交网络、分子结构、知识图谱、交通网络等。
...
| 模型 | 特点 |
| --- | --- |
| GCN（Graph Convolutional Network） | 基于邻接矩阵做平滑传播 |
| GraphSAGE | 从邻居采样并聚合，适合大图 |
| GAT（Graph Attention Network） | 使用注意力给邻居分配权重 |
