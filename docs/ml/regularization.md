...
![过拟合与泛化误差](https://cdn.jsdelivr.net/gh/YZJss/tuchuang@main/images/ml/overfitting-validation-curve.svg)

图：过拟合与泛化误差示意。图片来源：[Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Overfitting_svg.svg)。
